...
ft_list_sort:                                               ; This function is intended for recursion.
    ...
    ; Verify base-case.
        ; Return if 'cmp' == NULL. We could remove this because it's practical to get segfaults when wrong arguments are passed.
        test        rsi, rsi                                ; Verify if 'cmp' function is not 0x0: begin_list != NULL.
        jz          .end                    

        ; Return if begin_list == NULL. We could remove this because it's practical to get segfaults when wrong arguments are passed.
